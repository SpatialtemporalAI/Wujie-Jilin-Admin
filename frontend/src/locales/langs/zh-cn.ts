const local: App.I18n.Schema = {
  ...
  route: {
    ...
    manage_menu_add: '新增',
    manage_menu_edit: '编辑',
    manage_menu_delete: '删除',
    manage_role_list: '查询',
    manage_role_add: '新增',
    manage_role_edit: '编辑',
    manage_role_delete: '删除',
    manage_user_list: '查询',
    manage_user_add: '新增',
    manage_user_edit: '编辑',
    ...
    manage_dict_add: '新增',
    manage_dict_edit: '编辑',
    manage_dict_delete: '删除',
    manage_config_list: '查询',
    manage_config_add: '新增',
    manage_config_edit: '编辑',
    manage_config_delete: '删除',
    manage_announcement_list: '查询',
    manage_announcement_add: '新增',
    manage_announcement_edit: '编辑',
    manage_announcement_delete: '删除',
    manage_announcement_publish: '发布',
    manage_file_list: '查询',
    manage_file_upload: '上传',
    manage_file_download: '下载',
    manage_file_delete: '删除',
    'manage_ip-blacklist_list': '查询',
    'manage_ip-blacklist_add': '新增',
    'manage_ip-blacklist_remove': '移除',
    merchant_list: '查询',
    merchant_add: '新增',
    merchant_edit: '编辑',
    merchant_delete: '删除',
    'log_login-log_list': '查询',
    ...
    manage_scheduler_edit: '编辑',
    manage_scheduler_delete: '删除',
    manage_scheduler_detail: '详情',
    manage_scheduler_status: '启停',
    manage_scheduler_trigger: '手动执行',
    'manage_scheduler-log_detail': '详情',
    'manage_scheduler-log_delete': '删除',
    robot_model_list: '查询',
    robot_model_add: '新增',
    robot_model_edit: '编辑',
    robot_model_delete: '删除',
    robot_manage_list: '查询',
    robot_manage_add: '新增',
    ...
    scene_group_add: '新增',
    scene_group_edit: '编辑',
    scene_group_delete: '删除',
    scene_map_list: '查询',
    scene_map_add: '新增',
    scene_map_edit: '编辑',
    scene_map_delete: '删除',
    scene_map_editor_list: '查询',
    scene_map_editor_add: '新增',
    scene_map_editor_edit: '编辑',
    scene_map_editor_delete: '删除',
    task_list: '查询',
    task_add: '新增',
    task_edit: '编辑',
    task_delete: '删除',
  ...
  page: {
    ...
    manage: {
      ...
      merchant: {
        ...
        editMerchant: '编辑商户',
        resetApiKey: '重置密钥',
        resetConfirm: '重置后旧密钥立即失效，确定重置？',
        apiKeyTitle: 'API 凭证',
        secretOnceTip: 'API Secret 仅展示一次，请立即复制保存。遗忘后只能重置。',
        showSecret: '显示',
        hideSecret: '隐藏',
        copy: '复制',
        copySuccess: '复制成功',
        ...
        form: {
          ...
          merchantCode: '请输入商户编码',
          merchantStatus: '请选择状态',
          contactName: '请输入联系人',
      ...
      face: {
        title: '人脸库管理',
        selectDb: '人脸库',
        selectDbFirst: '请先选择人脸库',
        createDb: '新建人脸库',
        dbNamePlaceholder: '请输入人脸库名称',
        addEntity: '新增实体',
        entityIdPlaceholder: '请输入实体标识（人物唯一 ID）',
        viewFaces: '查看人脸',
        entityId: '实体标识',
        faceCount: '人脸数',
        labels: '标签',
        ...
        noFaces: '暂无人脸图片',
        searchTitle: '人脸搜索',
        searchTip: '上传人脸图片，在所选人脸库中匹配最相似的实体',
        limit: '匹配数量',
        noMatch: '未匹配到任何实体',
        confidence: '置信度',
        detectTitle: '人脸检测',
        detectTip: '上传图片，检测其中的人脸位置',
        maxFaceNum: '最大人脸数',
        faceRect: '人脸框',
        probability: '概率',
        noFace: '未检测到人脸'
