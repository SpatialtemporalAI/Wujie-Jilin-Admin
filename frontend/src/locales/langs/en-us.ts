const local: App.I18n.Schema = {
  ...
  route: {
    ...
    monitor_view: 'View',
    manage_menu_list: 'List',
    manage_menu_add: 'Add',
    manage_menu_edit: 'Edit',
    manage_menu_delete: 'Delete',
    manage_role_list: 'List',
    manage_role_add: 'Add',
    manage_role_edit: 'Edit',
    manage_role_delete: 'Delete',
    manage_user_list: 'List',
    manage_user_add: 'Add',
    manage_user_edit: 'Edit',
    manage_user_delete: 'Delete',
    manage_dict_list: 'List',
    manage_dict_add: 'Add',
    manage_dict_edit: 'Edit',
    manage_dict_delete: 'Delete',
    manage_config_list: 'List',
    manage_config_add: 'Add',
    manage_config_edit: 'Edit',
    manage_config_delete: 'Delete',
    manage_announcement_list: 'List',
    manage_announcement_add: 'Add',
    manage_announcement_edit: 'Edit',
    manage_announcement_delete: 'Delete',
    manage_announcement_publish: 'Publish',
    manage_file_list: 'List',
    manage_file_upload: 'Upload',
    manage_file_download: 'Download',
    manage_file_delete: 'Delete',
    'manage_ip-blacklist_list': 'List',
    'manage_ip-blacklist_add': 'Add',
    'manage_ip-blacklist_remove': 'Remove',
    merchant_list: 'List',
    merchant_add: 'Add',
    merchant_edit: 'Edit',
    merchant_delete: 'Delete',
    'log_login-log_list': 'List',
    ...
    manage_scheduler_edit: 'Edit',
    manage_scheduler_delete: 'Delete',
    manage_scheduler_detail: 'Detail',
    manage_scheduler_status: 'Enable/Disable',
    manage_scheduler_trigger: 'Run Now',
    'manage_scheduler-log_detail': 'Detail',
    'manage_scheduler-log_delete': 'Delete',
    robot_model_list: 'List',
    robot_model_add: 'Add',
    robot_model_edit: 'Edit',
    robot_model_delete: 'Delete',
    robot_manage_list: 'List',
    robot_manage_add: 'Add',
    ...
    scene_group_delete: 'Delete',
    scene_map_list: 'List',
    scene_map_add: 'Add',
    scene_map_edit: 'Edit',
    scene_map_delete: 'Delete',
    scene_map_editor_list: 'List',
    scene_map_editor_add: 'Add',
    scene_map_editor_edit: 'Edit',
    scene_map_editor_delete: 'Delete',
    task_list: 'List',
    task_add: 'Add',
    task_edit: 'Edit',
    task_delete: 'Delete',
  ...
  page: {
    ...
    manage: {
      ...
      merchant: {
        ...
        contactEmail: 'Email',
        remark: 'Remark',
        bindRobot: 'Bind Robots',
        addMerchant: 'Add Merchant',
        editMerchant: 'Edit Merchant',
        resetApiKey: 'Reset API Key',
        resetConfirm: 'Reset will invalidate the old key immediately. Continue?',
        apiKeyTitle: 'API Credentials',
        secretOnceTip: 'The API Secret is shown only once. Copy and save it now. If lost, you can only reset it.',
        showSecret: 'Show',
        hideSecret: 'Hide',
        copy: 'Copy',
        copySuccess: 'Copied',
        ...
        form: {
          ...
          merchantCode: 'Please enter merchant code',
          merchantStatus: 'Please select status',
      ...
      face: {
        title: 'Face DB Management',
        selectDb: 'Face DB',
        selectDbFirst: 'Please select a face DB first',
        createDb: 'Create DB',
        dbNamePlaceholder: 'Please enter face DB name',
        addEntity: 'Add Entity',
        entityIdPlaceholder: 'Please enter entity ID (unique person ID)',
        viewFaces: 'View Faces',
        entityId: 'Entity ID',
        faceCount: 'Face Count',
        labels: 'Labels',
        createdAt: 'Created At',
        facesTitle: 'Face Images',
        facesSub: 'Entity',
        faceId: 'Face ID',
        uploadFace: 'Upload Face',
        uploadImage: 'Upload Image',
        noFaces: 'No face images',
        searchTitle: 'Face Search',
        searchTip: 'Upload a face image to match the most similar entities in the selected DB',
        limit: 'Match Count',
        noMatch: 'No matching entity found',
        confidence: 'Confidence',
        detectTitle: 'Face Detection',
        detectTip: 'Upload an image to detect faces within it',
        maxFaceNum: 'Max Faces',
        faceRect: 'Face Rect',
