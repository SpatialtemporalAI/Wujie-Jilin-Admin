...
class RouteMetaResponse(BaseModel):
    ...
    icon: str | None = Field(None, description="路由图标（iconify 名称，与 localIcon 互斥）")
    localIcon: str | None = Field(None, description="本地图标名（src/assets/svg-icon 下的文件名，与 icon 互斥）")
