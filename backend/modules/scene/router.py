...
from .endpoints.scene_map_editor import scene_map_editor_router, scene_map_editor_public_router
...
router.include_router(scene_map_editor_public_router)      # /scene/map-editor
