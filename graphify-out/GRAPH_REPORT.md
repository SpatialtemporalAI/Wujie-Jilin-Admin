...
## Corpus Check
- 1033 files · ~531,112 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10570 nodes · 20992 edges · 1430 communities (830 shown, 600 thin omitted)
- Extraction: 66% EXTRACTED · 34% INFERRED · 0% AMBIGUOUS · INFERRED: 7236 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `adb970e3`
...
1. `NotFoundError` - 324 edges
2. `ResponseModel` - 321 edges
3. `PageRequest` - 314 edges
4. `BaseRespEntity` - 211 edges
...
## Communities (1430 total, 600 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (43): headerProps, isTopHybridHeaderFirst, isTopHybridSidebarFirst, isVerticalHybridHeaderFirst, isVerticalMix, layoutMode, siderCollapsedWidth, siderVisible (+35 more)
...
Cohesion: 0.06
Nodes (145): CustomErrorCode, Any, ConfigType, str, bool, login(), Request, str (+137 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (85): str, int, str, WebSocket, Any, int, str, AsyncSession (+77 more)

### Community 5 - "Community 5"
Cohesion: 0.09
Nodes (63): MapInfo, SceneMap, str, int, RetryCallResult, AsyncSession, bytes, EditorSaveRequest (+55 more)
...
Cohesion: 0.18
Nodes (52): AsyncSession, bool, int, Select, str, SysDictBatchUpdateStatus, SysDictCreate, SysDictItemBatchUpdateStatus (+44 more)

### Community 10 - "Community 10"
Cohesion: 0.18
Nodes (47): AsyncSession, int, PageRequest, Request, str, SysDictBatchUpdateStatus, SysDictCreate, SysDictItemBatchUpdateStatus (+39 more)

### Community 11 - "Community 11"
Cohesion: 0.28
Nodes (34): AuthorizationError, Any, Exception, FastAPI, HTTPException, bytes, Exception, UploadFile (+26 more)
...
Cohesion: 0.15
Nodes (41): datetime, bool, AsyncSession, int, IpBlacklistCreateRequest, IpBlacklistQueryParams, PageRequest, SysUser (+33 more)
...
Cohesion: 0.05
Nodes (87): str, str, str, int, str, BaseEntity, BaseRespEntity, PageRequest (+79 more)
...
Cohesion: 0.21
Nodes (17): str, WebSocket, int, str, notification_websocket(), 通知推送 WebSocket 端点      连接流程：     1. 从 URL Query 参数获取 token     2. 解码并验证 JWT, get_redis_util(), 获取Redis工具实例     Returns:         RedisUtil: Redis工具实例 (+9 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (24): useAuth(), permission, HeaderPlugin, _headerPlugins, local, local, setDayjsLocale(), getLocale() (+16 more)
...
Cohesion: 0.15
Nodes (37): AsyncSession, int, PageRequest, Request, SysUser, SysUserCreate, SysUserPasswordUpdate, SysUserQueryParams (+29 more)
...
Cohesion: 0.08
Nodes (90): Task, TaskExecutionRecord, Request, SysUser, AsyncSession, bool, int, PageRequest (+82 more)

### Community 41 - "Community 41"
Cohesion: 0.40
Nodes (35): AsyncSession, int, PageRequest, Request, RobotFaceRecognitionCreate, RobotFaceRecognitionUpdate, RobotVoiceConfigSchema, SysUser (+27 more)
...
Cohesion: 0.05
Nodes (68): BaseModel, BaseReqEntity, ClientIDModel, code_validator(), CurrentRobotModel, LoginModel, LoginPwdModel, LoginResponseData (+60 more)
...
Cohesion: 0.04
Nodes (54): Any, Any, RobotEventLogDetailResponse, RobotEventLogQueryParams, RobotEventLogResponse, GrpcServiceConfig, 机器人型号创建请求模型     用于创建新型号时的请求数据, 机器人型号更新请求模型     用于更新型号信息时的请求数据 (+46 more)
...
Cohesion: 0.17
Nodes (41): AsyncSession, datetime, int, Merchant, Robot, SceneMapAnnotation, str, AsyncSession (+33 more)
...
Cohesion: 0.12
Nodes (18): float, int, Request, str, FastAPI, BaseHTTPMiddleware, GlobalSetting, OperationLogMiddleware (+10 more)
...
Cohesion: 0.07
Nodes (33): ApiStatsQueryParams, AsyncSession, 系统用户查询参数模型     用于用户列表分页查询时的筛选条件, 系统菜单简单响应模型     用于只需要展示基本菜单信息的场景, 系统菜单简单响应模型     用于只需要展示基本菜单信息的场景, SysMenuSimpleResponse, ApiStatsQueryParams, ApiStatsResponse (+25 more)
...
Cohesion: 0.12
Nodes (27): bool, bytes, float, int, Request, Response, str, Any (+19 more)
...
Cohesion: 0.03
Nodes (22): fetchGetCaptcha(), fetchGetUserInfo(), fetchLogin(), fetchRefreshToken(), fetchVerifyCaptcha(), { baseURL }, fetchDownloadExportFile(), fetchSubmitExportTask() (+14 more)
...
Cohesion: 0.25
Nodes (21): AsyncSession, bool, int, Merchant, MerchantCreate, MerchantQueryParams, MerchantUpdate, Select (+13 more)
...
Cohesion: 0.06
Nodes (68): Select, SysFileQueryParams, AsyncSession, bool, int, LoginLogQueryParams, str, AsyncSession (+60 more)
...
Cohesion: 0.25
Nodes (25): AsyncSession, bool, int, Select, str, SysUser, SysUserCreate, SysUserPasswordUpdate (+17 more)
...
Cohesion: 0.13
Nodes (52): AsyncSession, bool, int, RobotModelCreate, RobotModelQueryParams, RobotModelUpdate, Select, AsyncSession (+44 more)
...
Cohesion: 0.16
Nodes (24): AsyncSession, int, PageRequest, TaskExecutionRecordQueryParams, _fill_relations(), get_active_execution_records(), get_execution_record_detail(), get_execution_record_history() (+16 more)
...
Cohesion: 0.14
Nodes (50): AsyncSession, bool, CallLogQueryParams, int, PageRequest, str, SysUser, AsyncSession (+42 more)
...
Cohesion: 0.09
Nodes (31): AsyncSession, int, Select, str, AsyncSession, int, PageRequest, RobotEventLogQueryParams (+23 more)
...
Cohesion: 0.08
Nodes (47): AsyncSession, bool, EditorSaveRequest, int, SysUser, UploadFile, AsyncSession, bool (+39 more)
...
Cohesion: 0.14
Nodes (29): bool, int, Request, str, Exception, add_ip_to_redis_blacklist(), _blacklist_key(), check_rate_limit() (+21 more)
...
Cohesion: 0.23
Nodes (13): bool, int, ORJSONResponse, Request, str, _build_429_response(), _build_blocked_response(), _extract_user_id() (+5 more)
...
Cohesion: 0.09
Nodes (37): clearAuthStorage(), getToken(), ChartHooks, ECOption, useEcharts(), useRouterPush(), connected, lastMessage (+29 more)
...
Cohesion: 0.15
Nodes (12): 2026-07-10 运行监控实时视频接入 LiveKit, code:env (LIVEKIT__ENABLED=true), 业务规则, 仍需确认, 关键设计, 后续注意, 已修复/已增强, 常见根因 (+4 more)
...
Cohesion: 0.07
Nodes (65): Any, bytes, str, AsyncSession, ExportTaskSubmit, int, str, SysUser (+57 more)
...
Cohesion: 0.10
Nodes (45): AsyncSession, int, PageRequest, Request, RobotModelCreate, RobotModelQueryParams, RobotModelUpdate, SysUser (+37 more)
...
Cohesion: 0.12
Nodes (39): AsyncSession, bool, int, PageRequest, Request, str, SysFileQueryParams, SysUser (+31 more)
...
Cohesion: 0.29
Nodes (7): 更新机器人行走速度等级（参数配置专用，权限 robot:config:edit）, 更新机器人行走速度等级（参数配置专用，权限 robot:config:edit）, 更新机器人行走速度等级（参数配置专用，权限 robot:config:edit）, 更新机器人行走速度等级（参数配置专用，权限 robot:config:edit）, 更新机器人行走速度等级（参数配置专用，权限 robot:config:edit）, 更新机器人行走速度等级（参数配置专用，权限 robot:config:edit）, update_speed_level()
...
Cohesion: 0.29
Nodes (7): 更新机器人电量报警阈值（参数配置专用，权限 robot:config:edit）, 更新机器人电量报警阈值（参数配置专用，权限 robot:config:edit）, 更新机器人电量报警阈值（参数配置专用，权限 robot:config:edit）, 更新机器人电量报警阈值（参数配置专用，权限 robot:config:edit）, 更新机器人电量报警阈值（参数配置专用，权限 robot:config:edit）, 更新机器人电量报警阈值（参数配置专用，权限 robot:config:edit）, update_battery_threshold()
...
## Knowledge Gaps
- **3234 isolated node(s):** `allow`, `PreToolUse`, `allow`, `additionalDirectories`, `recommendations` (+3229 more)
...
- **Why does `Client` connect `Community 1313` to `Community 41`, `Community 11`, `Community 28`, `Community 863`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `RequestError` connect `Community 41` to `Community 1`, `Community 1313`, `Community 5`, `Community 11`, `Community 1195`, `Community 45`, `Community 17`, `Community 1238`, `Community 537`, `Community 863`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `ResponseModel` connect `Community 34` to `Community 1`, `Community 3`, `Community 4`, `Community 6`, `Community 10`, `Community 11`, `Community 19`, `Community 150`, `Community 26`, `Community 1307`, `Community 1053`, `Community 30`, `Community 1317`, `Community 40`, `Community 41`, `Community 46`, `Community 177`, `Community 178`, `Community 59`, `Community 1233`, `Community 488`, `Community 503`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Are the 320 inferred relationships involving `NotFoundError` (e.g. with `FastAPI` and `Request`) actually correct?**
  _`NotFoundError` has 320 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 209 inferred relationships involving `BaseRespEntity` (e.g. with `SysConfigBaseResp` and `SysDictSimpleResponse`) actually correct?**
  _`BaseRespEntity` has 209 INFERRED edges - model-reasoned connections that need verification._