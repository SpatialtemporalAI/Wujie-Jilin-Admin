...
## Corpus Check
- 994 files · ~518,216 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10084 nodes · 19989 edges · 1337 communities (813 shown, 524 thin omitted)
- Extraction: 65% EXTRACTED · 35% INFERRED · 0% AMBIGUOUS · INFERRED: 6898 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `981b36bb`
...
## Communities (1337 total, 524 thin omitted)
...
Cohesion: 0.04
Nodes (15): fetchCreateSceneGroup(), fetchCreateSceneMap(), fetchUpdateSceneGroup(), fetchUpdateSceneMap(), fetchCreateDict(), fetchCreateDictItem(), fetchCreateMenu(), fetchCreateRole() (+7 more)
...
Cohesion: 0.09
Nodes (21): 发送app通知         Args:             alert_data: 报警数据, 验证用户凭据         通过手机号查找用户并验证验证码         Args:             phone: 手机号, 刷新access token         Args:             refresh_token: 刷新令牌         Returns:, 验证token中的session_id是否有效         Args:             token: JWT令牌         Return, 用户注册后的回调         可以在这里实现用户注册后的额外逻辑，如发送欢迎邮件等         Args:             user: 注, 用户注册后的回调         可以在这里实现用户注册后的额外逻辑，如发送欢迎邮件等         Args:             user: 注, 获取当前认证的用户         这是一个直接可用的FastAPI依赖项，封装了JWTAuthManager.current_user方法，, 获取当前认证的用户         这是一个直接可用的FastAPI依赖项，封装了JWTAuthManager.current_user方法， (+13 more)
...
Cohesion: 0.05
Nodes (80): ApiStatsQueryParams, AsyncSession, str, str, 系统用户查询参数模型     用于用户列表分页查询时的筛选条件, BaseEntity, BaseRespEntity, MerchantApiKeyResetResponse (+72 more)
...
Cohesion: 0.06
Nodes (23): useAuth(), permission, HeaderPlugin, _headerPlugins, local, local, getLocale(), i18n (+15 more)
...
Cohesion: 0.14
Nodes (37): AsyncSession, bool, int, Merchant, MerchantCreate, MerchantQueryParams, MerchantUpdate, Select (+29 more)
...
Cohesion: 0.07
Nodes (58): BaseSettings, str, BaseModel, get_current_env(), get_env_file_path(), import_config_class(), load_config(), 加载多环境配置的核心入口：     1. 获取当前环境标识     2. 动态导入对应的配置类     3. 配置 .env 文件路径（若存在） (+50 more)
...
Cohesion: 0.10
Nodes (64): Task, AsyncSession, bool, int, PageRequest, Request, Robot, SysUser (+56 more)
...
Cohesion: 0.04
Nodes (66): int, str, BaseReqEntity, 场景分组简化响应模型     用于下拉选择等轻量场景，仅暴露 id / name, SceneGroupCreate, SceneGroupQueryParams, SceneGroupResponseData, SceneGroupSimpleResponse (+58 more)
...
Cohesion: 0.11
Nodes (28): float, int, str, bool, float, int, Request, str (+20 more)
...
Cohesion: 0.19
Nodes (38): AsyncSession, int, Merchant, Robot, SceneMapAnnotation, str, TaskExecutionRecord, bool (+30 more)

### Community 55 - "Community 55"
Cohesion: 0.16
Nodes (13): fetchGetCaptcha(), fetchGetUserInfo(), fetchLogin(), fetchRefreshToken(), fetchVerifyCaptcha(), useAuthStore, { baseURL, otherBaseURL }, demoRequest (+5 more)

### Community 56 - "Community 56"
Cohesion: 0.12
Nodes (17): float, int, Request, str, FastAPI, BaseHTTPMiddleware, GlobalSetting, RateLimitMiddleware (+9 more)
...
Cohesion: 0.11
Nodes (20): AsyncSession, int, Select, str, AsyncSession, int, PageRequest, get_page_params() (+12 more)
...
Cohesion: 0.13
Nodes (42): AliyunSMS, 获取用户信息         Args:             user_id: 用户ID         Returns:, 获取用户信息         Args:             user_id: 用户ID         Returns:, 更新用户信息（PostgreSQL + SQLAlchemy异步版）, 更新用户信息（PostgreSQL + SQLAlchemy异步版）, 获取用户管理器实例     Args:         user_db: 用户数据库实例     Yields:         UserManager, 获取用户管理器实例     Args:         user_db: 用户数据库实例     Yields:         UserManager, update_user_info() (+34 more)
...
Cohesion: 0.12
Nodes (17): bool, str, str, batch_fix_imports(), batch_generate_grpc(), fix_imports(), 修复生成文件中的导入路径，精确匹配import和from...import语法, 批量生成指定目录下所有.proto文件的Python代码      :param proto_dir: 存放.proto文件的目录     :param (+9 more)
...
Cohesion: 0.12
Nodes (52): AsyncSession, bool, int, PageRequest, Request, str, SysFileQueryParams, SysUser (+44 more)
...
Cohesion: 0.31
Nodes (10): AsyncSession, int, Select, RobotLocationItem, RobotStatusRecord, RobotStatusRecordQueryParams, build_query(), get_latest() (+2 more)
...
Cohesion: 0.10
Nodes (10): Base, DataClassBase, DateTimeMixin, LogicMixin, 基础模型类 提供所有模型共享的字段和方法, __table_args__(), UserMixin, SysScheduledTask (+2 more)
...
Cohesion: 0.26
Nodes (28): AsyncSession, Merchant, Request, AsyncSession, Merchant, Merchant, get_current_merchant(), 解析并校验商户 HMAC 签名，返回商户对象 (+20 more)
...
Cohesion: 0.20
Nodes (26): AsyncSession, int, PageRequest, Request, SysUser, TaskExecutionQueryParams, AsyncSession, int (+18 more)
...
Cohesion: 0.10
Nodes (21): clearAuthStorage(), getToken(), ChartHooks, ECOption, useEcharts(), connected, lastMessage, useWebSocketNotification() (+13 more)
...
Cohesion: 0.18
Nodes (3): fetchCreateMerchant(), fetchToggleMerchant(), fetchUpdateMerchant()
...
Cohesion: 0.15
Nodes (7): 系统用户表     存储系统管理用户的基本信息和认证凭证, 系统用户表     存储系统管理用户的基本信息和认证凭证, Base, SysExportTask, 系统登录日志表     记录用户登录尝试（成功和失败）, SysLoginLog, SysUser

## Knowledge Gaps
- **3179 isolated node(s):** `allow`, `PreToolUse`, `allow`, `additionalDirectories`, `recommendations` (+3174 more)
...
- **Why does `Client` connect `Community 1327` to `Community 11`, `Community 28`, `Community 863`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `RequestError` connect `Community 11` to `Community 0`, `Community 1`, `Community 5`, `Community 1195`, `Community 45`, `Community 1327`, `Community 1172`, `Community 1019`, `Community 863`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `NotFoundError` connect `Community 5` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 517`, `Community 6`, `Community 136`, `Community 9`, `Community 11`, `Community 912`, `Community 19`, `Community 1172`, `Community 21`, `Community 147`, `Community 23`, `Community 537`, `Community 1306`, `Community 1307`, `Community 924`, `Community 1053`, `Community 30`, `Community 543`, `Community 1312`, `Community 1313`, `Community 34`, `Community 40`, `Community 41`, `Community 42`, `Community 1195`, `Community 45`, `Community 50`, `Community 54`, `Community 58`, `Community 59`, `Community 1219`, `Community 1233`, `Community 94`, `Community 488`, `Community 490`, `Community 114`, `Community 503`, `Community 509`?**
