# Graph Report - Wujie-Jilin-Admin  (2026-07-11)

## Corpus Check
- 1035 files · ~531,830 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10609 nodes · 21054 edges · 1447 communities (839 shown, 608 thin omitted)
- Extraction: 66% EXTRACTED · 34% INFERRED · 0% AMBIGUOUS · INFERRED: 7262 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ca64329c`
...
## Communities (1447 total, 608 thin omitted)
...
Cohesion: 0.06
Nodes (87): Select, SysFileQueryParams, MapInfo, SceneMap, str, int, RetryCallResult, AsyncSession (+79 more)

### Community 6 - "Community 6"
Cohesion: 0.38
Nodes (15): AsyncSession, int, Request, SysPermissionCreate, SysPermissionUpdate, SysUser, create_permission(), delete_permission() (+7 more)
...
Cohesion: 0.23
Nodes (19): AsyncSession, int, IpBlacklistCreateRequest, IpBlacklistQueryParams, PageRequest, SysUser, str, IpBlacklistBatchDeleteRequest (+11 more)
...
Cohesion: 0.02
Nodes (201): ApiStatsQueryParams, AsyncSession, str, str, Any, int, int, str (+193 more)

### Community 21 - "Community 21"
Cohesion: 0.20
Nodes (35): AsyncSession, bool, ConnectionManager, int, MyNoticeQueryParams, Select, SysNoticeCreate, SysNoticeQueryParams (+27 more)
...
Cohesion: 0.12
Nodes (14): get_editor_data(), 获取地图编辑器所需的完整数据（地图元数据 + 标注 + 路径 + 物体）, 获取地图编辑器所需的完整数据（地图元数据 + 标注 + 路径 + 物体）, 获取地图编辑器所需的完整数据（地图元数据 + 标注 + 路径 + 物体）, 获取地图编辑器所需的完整数据（地图元数据 + 标注 + 路径 + 物体）, 获取地图编辑器所需的完整数据（地图元数据 + 标注 + 路径 + 物体）, 获取地图编辑器所需的完整数据（地图元数据 + 标注 + 路径 + 物体）, 批量保存编辑器数据（标注、路径、物体的增删改） (+6 more)
...
Cohesion: 0.11
Nodes (66): AsyncSession, SysUser, AsyncSession, bool, int, PageRequest, SysUser, TenantConfigUpdate (+58 more)
...
Cohesion: 0.12
Nodes (33): BaseSettings, str, BaseModel, get_current_env(), import_config_class(), load_config(), 加载多环境配置的核心入口：     1. 获取当前环境标识     2. 动态导入对应的配置类     3. 配置 .env 文件路径（若存在）, 从系统环境变量获取当前环境标识，优先顺序：     1. 系统环境变量 ENVIR / APP_ENV（优先级最高）     2. 默认环境 DEFAULT (+25 more)

### Community 39 - "Community 39"
Cohesion: 0.13
Nodes (22): bool, float, int, str, int, str, get_redis_util(), 获取Redis工具实例     Returns:         RedisUtil: Redis工具实例 (+14 more)
...
Cohesion: 0.20
Nodes (46): AsyncSession, int, PageRequest, Request, RobotFaceRecognitionCreate, RobotFaceRecognitionUpdate, RobotVoiceConfigSchema, SysUser (+38 more)
...
Cohesion: 0.13
Nodes (41): Any, AsyncSession, bool, float, int, RetryCallResult, str, timedelta (+33 more)
...
Cohesion: 0.12
Nodes (26): int, str, UploadFile, add_face_entity(), add_face_image(), create_face_db(), delete_face(), delete_face_entity() (+18 more)
...
Cohesion: 0.07
Nodes (54): bool, int, str, bool, bytes, int, str, StorageBackend (+46 more)
...
Cohesion: 0.23
Nodes (35): AsyncSession, datetime, int, Merchant, Robot, SceneMapAnnotation, str, 机器人语音配置表     按机器人存储唤醒词与TTS参数 (+27 more)
...
Cohesion: 0.08
Nodes (85): 创建一个权限校验依赖项      Args:         permission_code: 权限标识码，如 "sys:menu:add"      Retu, 创建一个权限校验依赖项      Args:         permission_code: 权限标识码，如 "sys:menu:add", 创建一个权限校验依赖项，只要拥有任意一个权限码即通过（OR 关系）。      用于同一接口被多个页面共享、且各自有独立权限码的场景，     例如 sc, require_any_permission(), require_permission(), str, AsyncSession, int (+77 more)
...
Cohesion: 0.20
Nodes (20): bool, bytes, float, int, Request, Response, str, MerchantCallLog (+12 more)
...
Cohesion: 0.19
Nodes (14): int, _current_millis(), generate_id(), Snowflake, int, SnowflakeInfo, _current_millis(), generate_id() (+6 more)
...
Cohesion: 0.08
Nodes (84): PageRequest, RobotEventLogQueryParams, PageRequest, RobotCreate, RobotMapBindingUpdate, RobotQueryParams, RobotUpdate, AsyncSession (+76 more)
...
Cohesion: 0.33
Nodes (28): AsyncSession, Merchant, execute_task(), goto_point(), list_points(), list_robots(), list_scenes(), list_tasks() (+20 more)
...
Cohesion: 0.05
Nodes (67): addDialogVisible, addSceneUploading, annotations, baseContextMenuOptions, configFileName, configUploading, confirmAddScene(), confirmAndRemoveElement() (+59 more)
...
Cohesion: 0.20
Nodes (22): AsyncSession, str, SysUser, AsyncSession, bool, str, SysMenu, SysUser (+14 more)
...
Cohesion: 0.04
Nodes (50): AsyncAttrs, 系统用户表     存储系统管理用户的基本信息和认证凭证, Base, DataClassBase, DateTimeMixin, LogicMixin, MappedBase, __tablename__() (+42 more)
...
Cohesion: 0.17
Nodes (15): float, int, str, AsyncSession, int, log_operation(), 操作日志装饰器      用法:         @log_operation(module="user", action="create", descr, 操作日志装饰器      用法:         @log_operation(module="user", action="create", descr (+7 more)
...
Cohesion: 0.13
Nodes (26): int, str, Client, add_face_entity(), add_face_image(), create_face_db(), delete_face(), delete_face_entity() (+18 more)
...
Cohesion: 0.19
Nodes (12): ABC, ConfigServiceAddrProvider, ConfigService gRPC 地址 Provider  按 robot_id + target 维度解析地址： - 默认实现 RobotConfigAd, 注入新的地址 Provider（一般不调用，默认就是 RobotConfigAddrProvider）, ConfigService gRPC 地址抽象接口（voice/speed/battery/face 共用）, 注入新的地址 Provider（一般不调用，默认就是 RobotConfigAddrProvider）, ConfigService gRPC 地址抽象接口（voice/speed/battery/face 共用）      target ∈ {"agent", ", 默认实现：从 settings.GRPC.CONFIG_SERVICE_ADDR 读取 (+4 more)
...
Cohesion: 0.28
Nodes (8): int, str, _extract_addr(), get_addr(), 返回所有绑定指定 map 且启用 target 的 robot 地址 [(robot_id, host:port), ...]          地图保存/切换, 返回所有启用该 target 的 robot 列表 [(robot_id, host:port), ...]          默认空列表，由支持广播的实现覆盖, 从 robot.grpc_config 解析地址的默认实现      - get_addr：单 robot 维度，按 target 子键返回 host:port, RobotConfigAddrProvider
...
Cohesion: 0.27
Nodes (10): str, get_env_file_path(), 根据环境标识返回对应的 .env 文件路径：     - 优先查找项目根目录下的 .env.{env}（如 .env.dev）     - 若文件不存在，返, batch_fix_imports(), batch_generate_grpc(), fix_imports(), 修复生成文件中的导入路径，精确匹配import和from...import语法, 批量生成指定目录下所有.proto文件的Python代码      :param proto_dir: 存放.proto文件的目录     :param (+2 more)
...
Cohesion: 0.09
Nodes (87): Task, TaskExecutionRecord, AsyncSession, bool, int, PageRequest, Request, Robot (+79 more)

### Community 1227 - "Community 1227"
Cohesion: 0.27
Nodes (16): AsyncSession, datetime, int, IpBlacklistCreateRequest, str, IP 黑名单表     permanent: 永久；temporary: 临时（expire_at 为空表示永久）, auto_block(), build_query() (+8 more)
...
Cohesion: 0.14
Nodes (30): AsyncSession, bool, int, str, SysPermissionCreate, SysPermissionUpdate, bool, AsyncSession (+22 more)
...
Cohesion: 0.17
Nodes (19): AsyncSession, int, SysUser, AsyncSession, int, batch_delete_logs(), clear_logs(), delete_log() (+11 more)
...
Cohesion: 0.12
Nodes (29): AsyncSession, int, Select, str, AsyncSession, int, OperationLogQueryParams, PageRequest (+21 more)
...
## Knowledge Gaps
- **3249 isolated node(s):** `allow`, `PreToolUse`, `allow`, `additionalDirectories`, `recommendations` (+3244 more)
...
- **Why does `Client` connect `Community 863` to `Community 11`, `Community 28`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `RequestError` connect `Community 11` to `Community 609`, `Community 1`, `Community 5`, `Community 40`, `Community 41`, `Community 1227`, `Community 17`, `Community 50`, `Community 24`, `Community 863`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `NotFoundError` connect `Community 147` to `Community 1`, `Community 3`, `Community 5`, `Community 136`, `Community 9`, `Community 11`, `Community 1295`, `Community 529`, `Community 17`, `Community 19`, `Community 21`, `Community 1430`, `Community 23`, `Community 24`, `Community 537`, `Community 27`, `Community 30`, `Community 1439`, `Community 1440`, `Community 1313`, `Community 34`, `Community 1444`, `Community 1318`, `Community 40`, `Community 41`, `Community 1322`, `Community 42`, `Community 1200`, `Community 50`, `Community 54`, `Community 59`, `Community 1219`, `Community 1226`, `Community 1227`, `Community 76`, `Community 1229`, `Community 94`, `Community 609`, `Community 1254`, `Community 509`?**
